...
public class DragonTreasure {
    ...
    public static Room[][] setupGame(){
        ...
        Room[][] rooms = {
                {new Room("Rum Sword", "Du ser en död kropp på golvet.\nDu kan gå österut [ö]\nDu kan gå söderut [s]"), new Room("Rum Monster", "Du ser en brinnande fackla i rummets ena hörn och känner en motbjudande stank.\nDu kan gå västerut [v]\nDu kan gå österut [ö]"), new Room("Rum Exit", "Du lämnar grottan med livet i behåll.")},
                {new Room("Rum Start", "Rummet Är upplyst av några ljus som sitter på ett bord framför dig.\nDu kan gå norrut [n]\nDu kan gå söderut [s]")},
                {new Room("Rum Key", "Du kommer in i ett fuktigt rum med vatten sipprandes längs den västra väggen.\nDu kan gå norrut [n]\nDu kan gå österut [ö] "), new Room("Rum Potion", "Du kommer in i ett fuktigt rum med vatten sipprandes längs den västra väggen.\nDu kan gå västerut [v]\nDu kan gå österut [ö]"), new Room("Rum Dragon", "Dörren är låst")}
        };
